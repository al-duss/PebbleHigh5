...
static char name[] = "justin";
static char nametag[] = "Logged in as ";
static char result[] = "";
void display() {
  static char body_text[50];
  snprintf(body_text, sizeof(body_text), "You connected with Alex");
...
static void window_load(Window *window) {
  ...
  text_layer_set_text(text_layer, "Waiting for High Five");
